...
.. __: https://github.com/DenizenScript/Denizen-For-Bukkit-Docs

You can post issues relating to Denizen itself and view changes to Denizen on the `Denizen GitHub Repo`__.

.. __: https://github.com/DenizenScript/Denizen-For-Bukkit

For a more detailed channel of help and support, consider joining our **Discord**! The invite link is
...
.. rst-class:: table-showcase-display
...
| `Discord`_                                               | `Forum`_                                                 |
+----------------------------------------------------------+----------------------------------------------------------+
| | Chat with us!                                          | | Share scripts and slow chatter                         |
+----------------------------------------------------------+----------------------------------------------------------+
| `Denizen Script Home Page`_                              | `Meta Documentation`_                                    |
+----------------------------------------------------------+----------------------------------------------------------+
| | A general home page with links like these              | | Documentation on individual commands, tags, world      |
|                                                          |   events, etc.                                           |
+----------------------------------------------------------+----------------------------------------------------------+
| `GitHub Repo`_                                           | `Tutorial Videos`_                                       |
+----------------------------------------------------------+----------------------------------------------------------+
| | The source code of Denizen 1 for Bukkit/Spigot         | | Legacy tutorial videos                                 |
+----------------------------------------------------------+----------------------------------------------------------+

.. _Discord: https://discord.gg/Q6pZGSR

.. _Forum: https://forum.denizenscript.com/

.. _Denizen Script Home Page: https://denizenscript.com/

.. _Meta Documentation: https://one.denizenscript.com/denizen/logs/

.. _GitHub Repo: https://github.com/DenizenScript/Denizen-For-Bukkit

.. _Tutorial Videos: https://one.denizenscript.com/denizen/vids/


.. rst-class:: table-showcase-display-minimized

+--------------------------------------------------------+---+--------------------------------------------------------+
| Download Pages                                         |   | Other Projects That Go With Denizen                    |
+========================================================+===+========================================================+
| `Spigot Resource Page`_                                |   | `Citizens2`_                                           |
+--------------------------------------------------------+---+--------------------------------------------------------+
| | Discussion and slow release builds                   |   | | Interact directly with Citizens NPCs                 |
+--------------------------------------------------------+---+--------------------------------------------------------+
| `Developmental Builds`_                                |   | `Depenizen`_                                           |
+--------------------------------------------------------+---+--------------------------------------------------------+
| | Quickly updated, unstable builds                     |   | | Integrates Denizen with various other plugins        |
+--------------------------------------------------------+---+--------------------------------------------------------+
| `Release Builds`_                                      |   | `DenizenScript Organization on GitHub`_                |
+--------------------------------------------------------+---+--------------------------------------------------------+
| | Regularly updated, semi-stable builds                |   | | Other projects of note, including Webizen and        |
|                                                        |   |   dDiscordBot                                          |
+--------------------------------------------------------+---+--------------------------------------------------------+

.. _Spigot Resource Page: https://www.spigotmc.org/resources/denizen.21039/

.. _Release Builds: http://ci.citizensnpcs.co/job/Denizen/

.. _Developmental Builds: http://ci.citizensnpcs.co/job/Denizen_Developmental/

.. _Citizens2: https://github.com/CitizensDev/Citizens2/blob/master/README.md

.. _Depenizen: https://github.com/DenizenScript/Depenizen/blob/master/README.md

.. _DenizenScript Organization on GitHub: https://github.com/DenizenScript
